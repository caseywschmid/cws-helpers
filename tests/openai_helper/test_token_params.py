...
class TestTokenParams:
    ...
    def test_standard_model_uses_max_tokens(self, helper):
        ...
        helper.create_chat_completion(prompt="Hello", model="gpt-4-turbo", max_tokens=100)
    ...
    def test_error_recovery(self, helper):
        ...
        helper.client.chat.completions.create.side_effect = [
            ValueError("Unsupported parameter: 'max_tokens' is not supported with this model. Use 'max_completion_tokens' instead."),
            second_mock_response
        ]
        
        # This should trigger the error but recover automatically
        response = helper.create_chat_completion(prompt="Hello", model="o3-mini", max_tokens=100)
    ...
    def test_custom_model_detection(self, helper):
        ...
        helper.create_chat_completion(prompt="Hello", model="o3-something-custom", max_tokens=100)
        ...
        helper.create_chat_completion(prompt="Hello", model="gpt-4o-custom", max_tokens=100)
